...
class PdfUtility:
    ...
    def split_pdf(input_file, output_dir1, output_dir2from PyPDF2 import PdfMerger, PdfReader, PdfWriter
...
class PdfUtility:
    ...
    def split_pdf(input_file, output_file1, output_file2, split_at):
        ...
        output_file1 = f"{output_dir}/part1.pdf"
        ...
        output_file2 = f"{output_dir}/part2.pdf"
